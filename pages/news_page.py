...
class NewsPage:
    def __init__(self, page: Page):
        self._page = page
        self.url = "https://gsz.gov.by/registration/news/public-list/"

        self.region_select = page.locator("#id_news_region")
        self.title_input = page.locator("#id_title")
        ...
        self.news_links = page.locator("a.news__link")
